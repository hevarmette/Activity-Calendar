...
- [x] **E2E tests with Playwright** — Config + test files covering: calendar navigation, activity detail view + save, search + filter, report grouping.
  ...
  ***
  ...
  - [ ] Allow to click link in the activity comparison page. Show how far behind over time an activity is from another, and ability to view auto laps instead of laps. also allow comparison of more than one activity. also ability to compare activities across the schema of a database. 
