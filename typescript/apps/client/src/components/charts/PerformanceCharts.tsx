		...
		<div className="space-y-4">
			<div className="inline-flex rounded-lg bg-gray-800 border border-gray-700 p-0.5" role="group" aria-label="X-axis mode">
				<button
					...
					className={xMode === "distance" ? "px-3 py-1.5 rounded-md text-xs font-medium text-white bg-orange-600" : "px-3 py-1.5 rounded-md text-xs font-medium text-gray-400 hover:text-gray-200 transition-colors"}
				>
					Distance
				</button>
				<button
					...
					className={xMode === "time" ? "px-3 py-1.5 rounded-md text-xs font-medium text-white bg-orange-600" : "px-3 py-1.5 rounded-md text-xs font-medium text-gray-400 hover:text-gray-200 transition-colors"}
				>
					Time
				</button>
			</div>
