	...
	return (
		<div className="space-y-4 rounded-xl border border-gray-800 bg-gray-900 p-4">
			...
			<div className="space-y-2 border-t border-gray-800 pt-3">
				...
				<OffsetControl label={nameA} color={colorA} value={offsetA} max={maxA} onChange={onOffsetA} />
				<OffsetControl label={nameB} color={colorB} value={offsetB} max={maxB} onChange={onOffsetB} />
			</div>
		</div>
	);
}
